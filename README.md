...
The app is built using the **Meta Interaction SDK**, **NuGet** for asset-loading dependencies, and the **Webcam Passthrough Manager** from <a href="https://github.com/xrdevrob/QuestCameraKit" target="_blank">QuestCameraKit</a> project.
